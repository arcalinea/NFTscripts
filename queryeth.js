...
// Hardcoded contract addresses to try
...
// var MyContract = web3.eth.contract(abi, niftyGateway);
// var myContractInstance = MyContract.at("0xfb6916095ca1df60bb79ce92ce3ea74c37c5d359");

const getABI = async (addr) => {
  let url = `https://api.etherscan.io/api?module=contract&action=getabi&address=${addr}&apikey=${secrets.ETHSCAN}`;
...
const populateData = async (abi, addr) => {
